...
QuantumultX:
[rewrite_local]
^https?:\/\/vip1\.kuwo\.cn\/(vip\/v2\/user\/vip|vip\/spi/mservice) url script-response-body hhttps://raw.githubusercontent.com/PF2022/surge-js/main/kw.js
[mitm]
hostname = vip1.kuwo.cn
***************************
Surge4 or Loon:
[Script]
http-response ^https?:\/\/vip1\.kuwo\.cn\/(vip\/v2\/user\/vip|vip\/spi/mservice) requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/PF2022/surge-js/main/kw.js
[MITM]
hostname = vip1.kuwo.cn
**************************/
